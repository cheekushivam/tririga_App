...
class CompletedTaskCard extends StatefulWidget {
  ...
  CompletedTaskCard({this.activeTask, this.completedTask, this.holdForPartsTask,
...
class _CompletedTaskCardState extends State<CompletedTaskCard> {
  ...
  _CompletedTaskCardState(this.activeTask, this.completedTask, this.holdForPartsTask,
      this.holdForRequestsTask);
