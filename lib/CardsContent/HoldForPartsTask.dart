...
class HoldForPartsTaskCard extends StatefulWidget {
  ...
  HoldForPartsTaskCard({this.activeTask, this.completedTask, this.holdForPartsTask,
    this.holdForRequestsTask});

  @override
  _HoldForPartsTaskCardState createState() => _HoldForPartsTaskCardState(
      this.activeTask,
      this.completedTask,
...
class _HoldForPartsTaskCardState extends State<HoldForPartsTaskCard> {
  ...
  _HoldForPartsTaskCardState(this.activeTask, this.completedTask, this.holdForPartsTask,
      this.holdForRequestsTask);
