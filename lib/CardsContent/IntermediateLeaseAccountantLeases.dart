...
import 'Leases.dart';
import 'LeaseAccountantRoleLeases.dart';

class IntermediateLeaseAccRole extends StatelessWidget {
      ...
      child: new Stack(
        children: <Widget>[
          new Container(
            ...
            child: new Container(
              decoration: new BoxDecoration(
                  color: Color.fromRGBO(129, 148, 123, 2.0),
  ...
  void _getDataFromFirebase(AsyncSnapshot<DataSnapshot> dataSnapshot) {
    try {
      var Data = dataSnapshot.data.value['LeaseAccountantLeases']['Draft'];
      var Data1 = dataSnapshot.data.value['LeaseAccountantLeases']['Active'];
      var Data2 = dataSnapshot.data.value['LeaseAccountantLeases']['Review In Progress'];
      var Data3 = dataSnapshot.data.value['LeaseAccountantLeases']['Processing'];
  ...
  void _onPressedButton() {
    ...
    Navigator.push(
      contextUse,
      MaterialPageRoute(builder: (context) => LeaseAccRoleRoleCard(draftLeaseAccRole: draftLeaseAccRole,activeLeaseAccRole: activeLeaseAccRole,ripLeaseAccRole: ripLeaseAccRole,processingLeaseAccRole: processingLeaseAccRole,)),
    );
  }
}
