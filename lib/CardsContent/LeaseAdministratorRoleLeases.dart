...
import 'Leases.dart';
import 'LeaseAdministratorRoleCardContent.dart';

class LeaseAdmRoleRoleCard extends StatefulWidget {
  ...
  LeaseAdmRoleRoleCard({this.draftLeaseAccRole, this.activeLeaseAccRole,
    this.ripLeaseAccRole, this.processingLeaseAccRole});

  @override
  _LeaseAdmRoleRoleCardState createState() => _LeaseAdmRoleRoleCardState(
      this.draftLeaseAccRole, this.activeLeaseAccRole,
      this.ripLeaseAccRole, this.processingLeaseAccRole
  );
}

class _LeaseAdmRoleRoleCardState extends State<LeaseAdmRoleRoleCard> {
  ...
  _LeaseAdmRoleRoleCardState(this.draftLeaseAccRole,
  ...
  static final topAppBar = AppBar(
    elevation: 0.1,
    backgroundColor: Color.fromRGBO(19, 55, 23, 1.0),
    title: new Center(
      child: Text("Lease Administrator Leases"),
    ),
    actions: <Widget>[
      IconButton(
        ...
        itemBuilder: (BuildContext context, int index) {
          return GestureDetector(
            onTap: (){
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => LadminRoleCardContent(lease:lease,)),
              );
            },
