...
class LaccRoleCardContent extends StatefulWidget {

  Leases lease = new Leases();


  LaccRoleCardContent({this.lease});

  @override
  _LaccRoleCardContentState createState() => new _LaccRoleCardContentState(
      this.lease
  );
}

class _LaccRoleCardContentState extends State<LaccRoleCardContent> {

  Leases lease = new Leases();


  _LaccRoleCardContentState(
      this.lease);
