...
class CompletedSRCard extends StatefulWidget {
  ...
  CompletedSRCard({this.issuedSR, this.completedSR, this.draftSR});

  @override
  _CompletedSRCardState createState() => _CompletedSRCardState(
      this.issuedSR, this.completedSR, this.draftSR
  );
}

class _CompletedSRCardState extends State<CompletedSRCard> {

  List<SRContent> issuedSR = new List<SRContent>();
  List<SRContent> completedSR = new List<SRContent>();
  List<SRContent> draftSR = new List<SRContent>();

  _CompletedSRCardState(this.issuedSR, this.completedSR, this.draftSR);
