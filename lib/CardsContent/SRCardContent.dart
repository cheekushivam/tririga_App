...
class SRCardContent extends StatefulWidget {

  SRContent srContent = new SRContent();


  SRCardContent({this.srContent});

  @override
  _SRCardContentState createState() => new _SRCardContentState(
       this.srContent
  );
}

class _SRCardContentState extends State<SRCardContent> {
  ...
  Widget build(BuildContext context) {
    ...
    String createdDate = srContent.createdDate.split("T")[0];
    final topContentText = Column(
      ...
      children: <Widget>[
        ...
        Text(
          srContent.requestClassification,
