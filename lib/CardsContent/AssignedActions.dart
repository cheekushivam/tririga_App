...
class AssignedActionCard extends StatefulWidget {
  ...
  AssignedActionCard({@required this.completedActions,@required this.acceptedActions,@required this.assignedActions});

  @override
  _AssignedActionCardState createState() => _AssignedActionCardState(
...
class _AssignedActionCardState extends State<AssignedActionCard> {

  List<ActionContent> completedActions = new List<ActionContent>();
  List<ActionContent> acceptedActions = new List<ActionContent>();
  List<ActionContent> assignedActions = new List<ActionContent>();

  _AssignedActionCardState(this.completedActions,this.acceptedActions,this.assignedActions);
...
//          future: FirebaseDatabase.instance.reference().child('tririga_Data').child('129208024').child('ActionItems').child('Active').once(),
